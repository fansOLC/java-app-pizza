...
<body>
						...
						<table class="table">
						    <tbody>
						    	...
						    	<tr>
						    		...
						    		<td>
						    			<select id="zpsddl" name="zasddl" class="selectpicker show-tick" data-size="10" data-width="65%">
										</select>
						    		</td>
						    		<td class="info">作案手段小类</td>
						    		<td>
										<select id="zpsdxl" name="zasdxl" class="selectpicker show-tick" data-size="10" data-width="65%">
										</select>
									</td>
						    	</tr>
						    	<tr>
						    	...
						    	<tr>
						    		...
						    		<td><select id="bjrxb" name="bjrxb" class="selectpicker show-tick"  data-width="65%">
	...
	<script src="static/js/jcjgl/dataEdit.js"></script>
